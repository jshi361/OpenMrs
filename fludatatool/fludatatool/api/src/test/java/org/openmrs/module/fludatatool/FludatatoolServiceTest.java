...
/**
 * This is a unit test, which verifies logic in FludatatoolService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class FludatatoolServiceTest {
	
	@InjectMocks
	FludatatoolServiceImpl basicModuleService;
